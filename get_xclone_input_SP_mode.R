...
if(length(args)!=5){
  ...
  message("                    \tif genes = 'NA' (unit_cn_blocks) required 5 cols: chr, start, end, cn, cell/sample_id. No header.")
  message("[2] genes           \tBED-like file with genomic coordinates of genes; 5 cols: chr, start, end, HUGO_name, ENSG_id. No header. [optional, write 'NA' to ignore this param, output will be based on copy number blocks]")
